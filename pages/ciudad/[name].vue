    ...
    <div v-else-if="cityData">
      <div class="banner-city">
        <div class="wrapper-banner">
          <h1 class="text-4xl font-bold mb-4 title-city">
            {{ cityData.name }}
          </h1>
        </div>
        <img
          :src="cityData.images[0]"
          alt="Banner image"
      ...
      <div class="wrapper-contenido">
        ...
        <div class="contenido-texto-city">
          ...
          <img
            :src="cityData.images[1]"
            alt="City description image"
            class="w-full h-64 object-cover mb-4 image-city"
          />
        </div>

        <h2 class="text-2xl font-semibold mb-2 text-end h2-city">
          Best Travel Time
        </h2>
        <div class="contenido-texto-city-inverse">
          <p class="mb-4 p-contenido-city">{{ cityData.bestTravelTime }}</p>
          <img
            :src="cityData.images[2]"
            alt="Best travel time image"
            class="w-full h-64 object-cover mb-4 image-city"
          />
        </div>
        ...
        <div class="contenido-texto-city">
          ...
          <img
            :src="cityData.images[3]"
            alt="Reasons to visit image"
            class="w-full h-64 object-cover mb-4 image-city"
          />
        </div>
          ...
          <swiper-slide v-for="poi in cityData.pointsOfInterest" :key="poi.id">
            <div class="card-city">
              <img
                ...
                class="w-full h-64 object-cover mt-2"
              />
        ...
        >
          <swiper-slide
            v-for="restaurant in cityData.restaurants"
            :key="restaurant.id"
          >
            <div class="card-city">
              <img
        ...
        >
          <swiper-slide
            v-for="accommodation in cityData.accommodations"
